...
public abstract class DMSWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
{
    protected static readonly Lazy<string> ContentRootFolder;

    static DMSWebTestBase()
    {
    ...
    protected override IWebHostBuilder CreateWebHostBuilder()
    {
        return base
            ...
            .UseSetting(WebHostDefaults.ApplicationKey, typeof(DMSWebMvcModule).Assembly.FullName);
    }
    ...
    {
        using (var context = IocManager.Resolve<DMSDbContext>())
        {
            action(context);
            context.SaveChanges();
        }
    ...
    protected async Task UsingDbContextAsync(Func<DMSDbContext, Task> action)
    {
        using (var context = IocManager.Resolve<DMSDbContext>())
        {
    ...
    protected async Task<T> UsingDbContextAsync<T>(Func<DMSDbContext, Task<T>> func)
    {
        T result;
