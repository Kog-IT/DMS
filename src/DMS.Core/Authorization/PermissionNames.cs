...
public static class PermissionNames
{
    ...
    public const string Pages_Customers_Contacts_Delete = "Pages.Customers.Contacts.Delete";
    ...
    public const string Pages_Visits = "Pages.Visits";
    public const string Pages_Visits_Create = "Pages.Visits.Create";
    public const string Pages_Visits_Edit = "Pages.Visits.Edit";
    ...
    public const string Pages_Orders_Approve = "Pages.Orders.Approve";
    ...
    public const string Pages_Invoices_Void = "Pages.Invoices.Void";
