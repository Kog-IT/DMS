...
public class SalesmanToWarehouseTransferAppService : DMSAppServiceBase, ISalesmanToWarehouseTransferAppService
{
    ...
    public async Task<ApiResponse<PagedResultDto<SalesmanToWarehouseTransferDto>>> GetAllAsync(PagedSalesmanToWarehouseTransferRequestDto input)
    {
        ...
        var dtos = transfers.Select(t => new SalesmanToWarehouseTransferDto
        {
            Id                = t.Id,
    ...
    private async Task<SalesmanToWarehouseTransferDto> EnrichAsync(SalesmanToWarehouseTransfer t)
    {
        ...
        return new SalesmanToWarehouseTransferDto
        {
            Id = t.Id, SalesmanId = t.SalesmanId, WarehouseId = t.WarehouseId,
            TransferDate = t.TransferDate, Notes = t.Notes, Status = t.Status, RejectionReason = t.RejectionReason,
            TransactionNumber = $"S2W-{t.Id:D5}", SalesManName = sName, WarehouseName = wName, CreatedDate = t.CreationTime,
        };
    }
}
