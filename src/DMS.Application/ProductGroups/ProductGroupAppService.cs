...
public class ProductGroupAppService : DmsCrudAppService<
    ProductGroup, ProductGroupDto, int,
    PagedProductGroupResultRequestDto,
    CreateProductGroupDto, UpdateProductGroupDto>, IProductGroupAppService
{
    public ProductGroupAppService(IRepository<ProductGroup, int> repository) : base(repository) { }

    protected override IQueryable<ProductGroup> CreateFilteredQuery(PagedProductGroupResultRequestDto input)
    {
